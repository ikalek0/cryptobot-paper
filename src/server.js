...
scheduleNightlyLearning();
  ...
  tgControls = tg.startCommandListener(() => ({...bot.getState(),instance:"PAPER",dailyPnlPct:bot._dailyPnlPct||0,momentumMult:bot.hourMultiplier||1,cryptoPanic:cryptoPanic.getStatus()}), { getBot: () => bot });
...
server.listen(PORT, ()=>console.log(`\n📋 CRYPTOBOT PAPER v3.1.20260403_094714 en http://localhost:${PORT} | Capital: $${CAPITAL_USDT} USDC\n`));
